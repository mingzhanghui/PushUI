...
var imageUrl = '../css/plug-in/icolorpicker/images/color.png';
function iColorShow(id, id2) {
    var eICP = jQuery("#" + id).offset();
...
this.iColorPicker = function() {
    jQuery("input.iColorPicker").each(function(i) {
        ...
        jQuery(this).css({'backgroundColor': jQuery(this).val(),'border':'1px solid #bbb'}).after('<a href="javascript:void(null)" id="icp_' + this.id + '" onclick="iColorShow(\'' + this.id + '\',\'icp_' + this.id + '\')"><img src="' + imageUrl + '" style="border:0;margin:0 0 0 3px;vertical-align:middle;"></a>')
    })
};
jQuery(function() {
    iColorPicker()
